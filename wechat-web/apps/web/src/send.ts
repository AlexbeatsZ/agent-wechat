...
export async function sendPayload(payload: Record<string, unknown>, optimistic?: MessageDto): Promise<boolean> {
...
export async function sendFile(file: File, asImage: boolean): Promise<void> {
