...
export function renderModals(): void {
  ...
  el.innerHTML = `
    ...
    ${state.previewImageUrl ? `<div class="modal image-preview-modal" data-action="close-preview"><div class="modal-panel image-preview-panel"><img src="${state.previewImageUrl}" alt="大图预览"></div></div>` : ""}
  `;
}
