    ...
    PA: Send,
{
    ...
    for step in 0..MAX_STEPS {
        ...
        // 1. OBSERVE: get a11y tree and, when the plan needs it, screenshot
        ...
        let screenshot = if plan.needs_screenshot() {
            capture_screenshot(&exec_options).await.unwrap_or_default()
        } else {
            String::new()
        };
